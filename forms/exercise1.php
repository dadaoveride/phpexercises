...
Create two separate files. The first will contain a form with one input field asking for the user's favorite city. Use the post method for the form. 
Although this file contains no PHP code, on my localhost, it needs the .php extension to successfully call the second file.
The second file will contain PHP code to process the user's response. (In this case, something very simple.) After the user clicks the submit button, 
...
<form action="favcity.php" method="post">
    <label for="favcity"> What is your favorite city? </label> <br>
    <input type="text" id="favcity" name="favcity"> <br>1
    <input type="submit">
</form>